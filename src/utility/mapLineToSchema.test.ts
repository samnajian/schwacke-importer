import {extractLineFields} from "./extractLineFields";
...
describe("mapeLineToSchema", () => {
    it("Works correctly for a single valid line (rims) ", () => {
        ...
        expect(extractLineFields(rimsStructure[0].schema)(line)).toEqual({
            code: "00002",
            width: "6.00 ",
            height: "J",
            one_piece: "x",
    ...
    it("Works correctly for a single valid line (timespans) ", () => {
        ...
        expect(extractLineFields(timespansStructure[0].schema)(line)).toEqual({
            id: "00601765",
